...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO almacen (fecha, consumible, cantidad, observaciones) VALUES (%s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" onsubmit="return validar()" name="form1" id="form1">
  <table align="center" cellpadding="4" class="bordes_tablas">
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#FFCC66"><strong>Cargar Almacen</strong></td>
    </tr>
    <tr valign="baseline">
      <td width="114" align="right" nowrap="nowrap"><strong>Fecha:</strong></td>
      <td width="428"><input name="fecha" type="text" id="fecha" value="<?=date("Y-m-d");?>" size="20" maxlength="10" readonly="readonly" />
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input name="cantidad" type="text" value="" size="20" maxlength="11" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="middle"><strong>Observaciones:</strong></td>
      <td><textarea name="observaciones" cols="40" rows="5" onKeyDown="if(this.value.length &gt;= 300){ alert('Has superado el tama&ntilde;o m&aacute;ximo permitido de este campo'); return false; }"></textarea></td>
    </tr>
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#FFCC66"><input type="submit" value="Cargar Datos" /></td>
    </tr>
  </table>
